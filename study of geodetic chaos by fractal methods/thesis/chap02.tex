...
\end{equation}
and the normalization of a time-like world-line is
\begin{equation}
    g_{\mu\nu}u^\mu u^\nu=-1.
    \label{eq:time-like-normalization-chap2}
\end{equation}
...
\end{equation}
It describes the exterior of a nonrotating, chargeless black hole of mass \(M\). The
