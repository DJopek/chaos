...
\newcommand{\basinLegend}{Colours: \basinDot{BasinPlunge}\,plunge; \basinDot{BasinOrbit}\,eternal orbit; white outside the accessible region (see colouring heuristics in Chapter~\ref{chap:implementation}).}
