...
%%% Colours used in basin maps (see Implementation/Heuristics)
\definecolor{BasinPlunge}{rgb}{0.478431,0.701961,0.937255} % (122,179,239)
\definecolor{BasinOrbit}{rgb}{0.0862745,0.4,0.729412}      % (22,102,186)

\DeclareRobustCommand{\basinDot}[1]{%
  \raisebox{0.10ex}{\textcolor{#1}{\scalebox{1.6}{$\bullet$}}}%
}
\newcommand{\basinLegend}{Colours: \basinDot{BasinPlunge}\,plunge/termination; \basinDot{BasinOrbit}\,eternal orbit; white outside the accessible region (see colouring heuristics in Chapter~\ref{chap:implementation}).}
